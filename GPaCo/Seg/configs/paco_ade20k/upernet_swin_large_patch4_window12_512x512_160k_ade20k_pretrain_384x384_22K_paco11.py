...
model = dict(
    ...
    backbone=dict(
        ...
        window_size=12),
    decode_head=dict(in_channels=[192, 384, 768, 1536], num_classes=150, type='UPerHead_paco11', alpha=0.01, temperature=0.07, K=8192, freq_file="stats/ade20k_image_label_stats.txt", lovasz_w=1.0, paco_w=1.0),
