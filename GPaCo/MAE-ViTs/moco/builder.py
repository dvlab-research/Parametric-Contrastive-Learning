...
class MoCo(nn.Module):
    ...
    """
    def __init__(self, base_encoder, dim=128, K=65536, m=0.999, T=0.2, mlp=True, num_classes=1000, drop_path_rate=0.1, global_pool=True):
        """
        ...
        self.encoder_q = base_encoder(num_classes=num_classes, drop_path_rate=drop_path, global_pool=global_pool)
        self.encoder_k = base_encoder(num_classes=num_classes, drop_path_rate=drop_path, global_pool=global_pool)
